...
class Comment extends Model {
  ...
  const Comment._internal({required this.id, required postID, required content, createdAt, updatedAt}): _postID = postID, _content = content, _createdAt = createdAt, _updatedAt = updatedAt;
  ...
  Map<String, dynamic> toJson() => {
    'id': id, 'postID': _postID, 'content': _content, 'createdAt': _createdAt?.format(), 'updatedAt': _updatedAt?.format()
  };
