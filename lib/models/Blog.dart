...
class Blog extends Model {
  ...
  const Blog._internal({required this.id, required name, posts, required isComplete, createdAt, updatedAt}): _name = name, _posts = posts, _isComplete = isComplete, _createdAt = createdAt, _updatedAt = updatedAt;
  
  factory Blog({String? id, required String name, List<Post>? posts, required bool isComplete}) {
  ...
  Blog copyWith({String? id, String? name, List<Post>? posts, bool? isComplete}) {
    return Blog._internal(
      id: id ?? this.id,
      name: name ?? this.name,
  ...
  Map<String, dynamic> toJson() => {
    'id': id, 'name': _name, 'posts': _posts?.map((Post? e) => e?.toJson()).toList(), 'isComplete': _isComplete, 'createdAt': _createdAt?.format(), 'updatedAt': _updatedAt?.format()
  };
